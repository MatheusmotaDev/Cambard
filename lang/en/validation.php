...
return [
    ...
    */
    ...
    | Isso facilita a especificação de uma mensagem de linguagem personalizada
    | para uma regra de atributo específica.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para trocar nosso marcador
    | de posição de atributo por algo mais amigável ao leitor, como "Endereço
    | de E-Mail" em vez de "email". Isso simplesmente nos ajuda a tornar nossa
